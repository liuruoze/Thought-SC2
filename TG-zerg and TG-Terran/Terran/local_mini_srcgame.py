...
import param as P
import terran_source_agent as terran_source_agent
...
flags.DEFINE_string("restore_model_path", "./model/20190223-225104_source/", "path for restore model")
flags.DEFINE_bool("restore_model", True, "Whether to restore old model")
# flags.DEFINE_string("restore_mini_path", "./model/20190222-195227_mini/", "path for restore mini")
...
flags.DEFINE_integer("port_num", 18377, "the start port to create distribute tf")
flags.DEFINE_integer("max_iters", 1000, "the rl agent max run iters")
