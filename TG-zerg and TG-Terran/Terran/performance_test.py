...
flags.DEFINE_string("restore_model_path", "./model/20190420-112836_source/", "path for restore model")
...
flags.DEFINE_string("log_file", "./result/PvT_AbyssalReef_log.txt", "log file to save data")
...
def Worker(index, update_game_num, Synchronizer, cluster, model_path):
    ...
    for i in range(THREAD_NUM):
        agent = mini_source_agent.SourceAgent(index=i, global_buffer=global_buffer, net=Net,
                                                  ...
                                                  strategy_agent=None, greedy_action=True)
        agents.append(agent)
