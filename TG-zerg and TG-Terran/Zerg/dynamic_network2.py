...
class DynamicNetwork(object):
    ...
    def predict_tech(self, last_state, last_action, use_transform=True):
    ...
    def predict_tech_batch(self, last_states, last_actions):
        # TODO add transform_state
        last_action_one_hot = self.one_hot_label(last_actions, C._SIZE_MAX_ACTIONS)
        # print(last_action_one_hot)
        feed_dict = {self.last_state: last_states,
                     self.last_action: last_action_one_hot,
                     self.is_training: False,
                     }
        tech_preds = self.tech_predict.eval(feed_dict, session=self.sess)
        ...
        for iter_index in range(iter_num):
            ...
            while step * batch_size <= train_num:
                ...
                feed_dict = {
                    ...
                    self.tech_label: batch_diff_observations[:, 1:2],
                    ...
                    if use_val:
                        ...
                        while val_step * batch_size + train_num <= sample_num:
                            ...
                            feed_dict = {
                                ...
                                self.tech_label: val_batch_diff_observations[:, 1:2],
    ...
    def one_hot_label(self, action_type, action_max_num):
