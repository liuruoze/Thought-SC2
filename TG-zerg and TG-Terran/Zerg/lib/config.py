...
_TRAIN_DRONE = sc2_actions.FUNCTIONS.Train_Drone_quick.id
_TRAIN_QUEEN = sc2_actions.FUNCTIONS.Train_Queen_quick.id
_TRAIN_ZERGLING = sc2_actions.FUNCTIONS.Train_Zergling_quick.id
_TRAIN_ROACH = sc2_actions.FUNCTIONS.Train_Roach_quick.id
_TRAIN_OVERLORD = sc2_actions.FUNCTIONS.Train_Overlord_quick.id
...
_BUILD_EXTRACTOR_S = sc2_actions.FUNCTIONS.Build_Extractor_screen.id
_BUILD_SPAWNINGPOOL_S = sc2_actions.FUNCTIONS.Build_SpawningPool_screen.id
_BUILD_ROACHWARREN_S = sc2_actions.FUNCTIONS.Build_RoachWarren_screen.id
...
_RALLY_HATCHERY_UNITS_S = sc2_actions.FUNCTIONS.Rally_Hatchery_Units_screen.id
...
class AbyssalReef:
    ...
    enemy_main_pos = [53, 50]   # [41, 45]s
    enemy_sub_pos = [43, 47]
    base_camera_pos = [12, 17]
    # rally_pos = [36, 22]
    # attack_pos_queue = [[48, 40], [43, 47], [53, 50]]
    rally_pos = [28, 24]
    attack_pos_queue = [[53, 50], [43, 47]]
