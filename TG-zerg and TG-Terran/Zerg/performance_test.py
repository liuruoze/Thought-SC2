...
flags.DEFINE_integer("port_num", 18991, "the start port to create distribute tf")
...
flags.DEFINE_string("log_file", "./result/19-02-23_ZvZ_Simple64_log_mini.txt", "log file to save data")
    ...
    for difficulty in Difficulty_list:
        with sc2_env.SC2Env(
            ...
            if agent.index == 0:
                ...
                log_path = "./result/" + FLAGS.agent_race + 'v' + FLAGS.bot_race + '_' + FLAGS.restore_model_path.split('/')[-2] + '_' + FLAGS.map + '.txt'
