...
def train(record_path, is_restore=False, is_norm=False):
    ...
    model_path = "./model/" + "20181223-174748" + "_dynamic/"
    ...
    dynamic_net.SL_train_tech_net(observations, tech_actions, next_observations, batch_size=10000, iter_num=10000, lr=1e-7)
