...
import param as P
import mini_source_agent_add_bn as mini_source_agent
...
kill -9 `ps -ef |grep liuruoze | grep eval_mini_srcgame_add_bn | awk '{print $2}' `
            ...
            if FLAGS.training:
                ...
                if num == game_num:
                    ...
                    # update!
                        ...
                        agent.update_network(Result_List, verbose=FLAGS.debug_mode)
                        Result_List.clear()
