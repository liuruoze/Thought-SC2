...
import param as P
import mini_source_agent_add_map as mini_source_agent
from mini_network_add_map import MiniNetwork
...
flags.DEFINE_integer("port_num", 5270, "the start port to create distribute tf")
...
# kill -9 `ps -ef |grep liuruoze | grep eval_mini_srcgame_add_map | awk '{print $2}' `
