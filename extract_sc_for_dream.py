...
" Extract 10000 episodes for building a dream model of SC2 "
...
# kill -9 `ps -ef |grep liuruoze | grep extract_sc.py | awk '{print $2}' `
# kill -9 `ps -ef |grep liuruoze | grep extract_sc_for_dream.py | awk '{print $2}' `
