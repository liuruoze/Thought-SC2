...
# This is the TG-3 module of original thought-game
...
class MiniAgent(A):
    ...
    def fullfill_creature_condition(self, unit):
        if self.mineral >= unit.mineral_price and self.gas >= unit.gas_price:
            if self.food_cup >= self.food_used + unit.food_used and 1:  # default is self.fullfill_technology(unit): , this is represent module N_4:Technology tree
                return True
        else:
            return False
