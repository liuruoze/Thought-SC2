...
class MiniSourceAgent(base_agent.BaseAgent):
    ...
    def update_network(self, result_list, verbose=False):
        self.net.Update_policy(self.global_buffer, verbose=verbose)
        self.net.Update_result(result_list)
    ...
    def play_right_add(self, verbose=False):
        ...
        while True:
            ...
            if self.policy_flag and (not self.is_end):
                ...
                #map_state = U.get_simple_map_data(self.obs)
                ...
                action, value = self.net.policy.get_action_more(state, add_state, verbose=verbose)
                ...
                if prev_state is not None:   
                    ...
                    self.local_buffer.append_more(prev_state, prev_add_state, prev_action, state, reward, prev_value, value)
            ...
            if self.is_end:
                ...
                value = self.net.policy.get_values(state, add_state)
