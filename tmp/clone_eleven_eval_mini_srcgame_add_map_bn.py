...
flags.DEFINE_integer("num_for_update", 500, "Number of episodes for each train.")
...
flags.DEFINE_enum("difficulty", "8", sc2_env.difficulties.keys(), "Bot's strength, default is 7")
...
flags.DEFINE_string("restore_model_path", "./model/20200914-231257_source/", "path for restore model")
...
flags.DEFINE_integer("port_num", 5770, "the start port to create distribute tf")
