...
from mini_agent_add_map_bn import MiniAgent
...
flags.DEFINE_integer("port_num", 5170, "Port number for distribute training in tensorflow")
flags.DEFINE_integer("seed", 1234, "seed for tensorflow and numpy")
