...
flags.DEFINE_integer("port_num", 11770, "the start port to create distribute tf")
...
flags.DEFINE_string("weighted_sum_type", "Add", "add weighted sum type: Add, AddWeight, AdaptiveWeight, AttentionWeight")
flags.DEFINE_string("initial_type", "xavier", "weight initial type: original, normal, xavier, he, zero")
FLAGS(sys.argv)
