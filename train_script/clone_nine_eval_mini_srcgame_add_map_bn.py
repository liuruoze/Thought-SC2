...
flags.DEFINE_enum("difficulty", "7", sc2_env.difficulties.keys(), "Bot's strength, default is 7")
...
flags.DEFINE_integer("port_num", 6870, "the start port to create distribute tf")
...
flags.DEFINE_integer("ob_space_add", 4, "Add state space from thought game:0,4, default is 4, ")
flags.DEFINE_integer("act_space_add", 5, "Add action space from thought game:0,5, default is 5")
flags.DEFINE_bool("add_image", True, "Whether add image for input, default is True")
