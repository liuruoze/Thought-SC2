...
flags.DEFINE_integer("port_num", 13770, "the start port to create distribute tf")
...
flags.DEFINE_string("initial_type", "he", "weight initial type: original, normal, xavier, he, zero, default is original")
FLAGS(sys.argv)
